...
enum RequestError: AbortError {
    ...
    var reason: String? {
        ...
        case .invalidMessageRole:
            return "An invalid message role was given. These must be either 'system', 'user', or 'assistant'."
        case .noPromptOrMessages:
...
enum ResponseError: AbortError {
    ...
    var status: HTTPResponseStatus {
        ...
        case .moderationError:
            return .init(statusCode: 402, reasonPhrase: ResponseError.moderationError.reason)
        }
    }
